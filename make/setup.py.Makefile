...
production-setup: install-build-system ## Install the production for dev environments
...
generate-production-requirements: install-build-system ## Generate a requirements.txt with production dependencies
	poetry export -f requirements.txt -o requirements.txt --without-hashes

generate-dev-requirements: install-build-system ## Generate a requirements.txt with all dependencies
